...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/phone)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/phone
```

A live public deployment of this template is available at [https://phone.templates.workers.dev](https://phone.templates.workers.dev)
